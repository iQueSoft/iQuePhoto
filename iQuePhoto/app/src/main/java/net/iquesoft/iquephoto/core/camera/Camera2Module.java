...
public class Camera2Module implements ImageReader.OnImageAvailableListener {
    ...
    public Camera2Module(Activity activity, Camera2View cameraView) {
        mActivity = activity;
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Size largest = Collections.max(
                        ...
                        new Camera2View.CompareSizesByArea());
    ...
    private static Size chooseOptimalSize(Size[] choices,
        ...
        if (bigEnough.size() > 0)
            return Collections.min(bigEnough, new Camera2View.CompareSizesByArea());
        else if (notBigEnough.size() > 0)
            return Collections.max(notBigEnough, new Camera2View.CompareSizesByArea());
        else
            return choices[0];
    }
