...
public class ImageLoader extends AsyncTask<Void, Void, List<ImageFolder>> {

    private Context mContext;
    private List<ImageFolder> mFoldersList;
    ...
    public interface OnImageLoadedListener {
        void onImageLoaded(List<ImageFolder> imageFolders);
    }
    ...
    protected List<ImageFolder> doInBackground(Void... params) {
        ...
        Map<String, ImageFolder> folderMap = new HashMap<>();
            ...
            if (cursor.moveToLast())
                do {
                    ...
                    if (file.exists()) {
                        ...
                        ImageFolder imageFolder = folderMap.get(folderName);
                        if (imageFolder == null) {
                            imageFolder = new ImageFolder(folderName);
                            folderMap.put(folderName, imageFolder);
                        }
    ...
    protected void onPostExecute(List<ImageFolder> imageFolders) {
        ...
        mListener.onImageLoaded(imageFolders);
    }
}
